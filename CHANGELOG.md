...
- **fix**: Ensure Terraform-managed VMs and containers receive the managed SSH public key alongside configured keys for account access. ([pending](https://github.com/edlundin/homelab/commit/pending))
