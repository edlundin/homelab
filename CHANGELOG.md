...
- **fix**: Schedule Digarr on the node where its runtime is stable and use a recreate rollout for its single-writer backup volume. ([pending](https://github.com/edlundin/homelab/commit/pending))
