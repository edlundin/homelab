...
- **fix**: Keep plaintext secret and Helm values files out of Argo CD directory deployments, and deploy the sealed Picsou secret. ([pending](https://github.com/edlundin/homelab/commit/pending))
