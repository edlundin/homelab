...
- **feat**: Let SUB/WAVE use the existing GPU-backed Chatterbox server through its OpenAI-compatible TTS API. ([pending](https://github.com/edlundin/homelab/commit/pending))
